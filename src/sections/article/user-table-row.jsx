...
export default function UserTableRow({
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected} onDoubleClick={handleClick}>
        ...
        <TableCell onClick={handleClick}>{company}</TableCell>

        <TableCell onClick={handleClick}>{role}</TableCell>
